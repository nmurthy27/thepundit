    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="max-w-md w-full bg-slate-900/40 backdrop-blur-3xl border border-white/10 rounded-[3rem] p-10 shadow-[0_32px_80px_-16px_rgba(0,0,0,0.7)] relative z-10 text-center">
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-black text-white mb-2 tracking-tighter leading-none">THE<br/><span className="text-blue-500">PUNDIT</span></h1>
          <p className="text-slate-400 font-bold uppercase tracking-[0.3em] text-[9px] mt-1">Authority Engine</p>
        </div>

        {error && (
          <div className="mb-6 p-4 bg-red-500/10 border border-red-500/20 rounded-2xl text-red-400 text-xs font-bold leading-relaxed text-left animate-in fade-in slide-in-from-top-2">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-left">
          {isRegister && (
            <div>
              <label className="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-1.5 ml-2">Name</label>
              <input 
                type="text" 
                required
                value={name}
          ...
          <div>
            ...
            <input 
              ...
              placeholder="pundit@industry.com"
              className="w-full bg-slate-800/50 border border-white/5 rounded-2xl py-4 px-5 text-white placeholder-slate-600 focus:outline-none focus:border-blue-500 transition-all text-sm"
            />
          </div>
          <div>
            <label className="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-1.5 ml-2">Password</label>
            <input 
              type="password" 
              required
              value={password}
